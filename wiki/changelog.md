...
Full history of the project with diffs, scanned from the beginning of time.

## hide the shame (cf40699) - 2025-03-20
...
## analytics (bf3dfbe) - 2025-03-20

```diff
diff --git a/package.json b/package.json
index fb347c8..36923fa 100644
--- a/package.json
+++ b/package.json
@@ -15,12 +15,13 @@
...
-            tailored education programs. n When I'm not working, you’ll find me
...
## add favicon (c25edec) - 2025-03-20

```diff
diff --git a/favicon.ico b/favicon.ico
new file mode 100644
index 0000000..535796d
Binary files /dev/null and b/favicon.ico differ
diff --git a/index.html b/index.html
index e4b78ea..e6b8bdb 100644
--- a/index.html
+++ b/index.html
@@ -2,9 +2,9 @@
<html lang="en">
...
## change profile image (63220cb) - 2025-07-29

```diff
diff --git a/src/assets/potraits.png b/src/assets/potraits.png
new file mode 100644
index 0000000..25fdbe1
Binary files /dev/null and b/src/assets/potraits.png differ
diff --git a/src/pages/About.tsx b/src/pages/About.tsx
index a8b3744..3e33d26 100644
--- a/src/pages/About.tsx
+++ b/src/pages/About.tsx
@@ -1,4 +1,4 @@
...
## feat: add baseURL SEO (ad508aa) - 2026-01-26

```diff
diff --git a/src/components/SEO.tsx b/src/components/SEO.tsx
index 04fb8ce..fa774aa 100644
...
## feat: add baseURL SEO (b53f6d2) - 2026-01-26

```diff
diff --git a/package.json b/package.json
index 6a46089..616edec 100644
--- a/package.json
+++ b/package.json
@@ -42,5 +42,9 @@
"typescript": "^5.5.3",
...
new file mode 100644
index 0000000..7522774
--- /dev/null
+++ b/tsconfig.app.tsbuildinfo
@@ -0,0 +1 @@
+{"root":["./src/app.tsx","./src/data.ts","./src/main.tsx","./src/types.ts","./src/vite-env.d.ts","./src/components/background3d.tsx","./src/components/header.tsx","./src/components/moderncard.tsx","./src/components/pixelcard.tsx","./src/components/seo.tsx","./src/components/scrollreveal.tsx","./src/components/skillbar.tsx","./src/components/skillcard.tsx","./src/pages/about.tsx","./src/pages/blog.tsx","./src/pages/experience.tsx"],"errors":true,"version":"5.9.3"}
 No newline at end of file
diff --git a/tsconfig.node.tsbuildinfo b/tsconfig.node.tsbuildinfo
new file mode 100644
index 0000000..62c7bf9
--- /dev/null
...
## feat: add baseURL SEO (200839d) - 2026-01-26

```diff
diff --git a/src/App.tsx b/src/App.tsx
index 17c9b05..e53124d 100644
--- a/src/App.tsx
+++ b/src/App.tsx
@@ -1,4 +1,4 @@
-import React, { Suspense } from 'react';
...
particles.forEach((particle, i) => {
let { t, factor, speed, xFactor, yFactor, zFactor } = particle;
diff --git a/src/components/SkillBar.tsx b/src/components/SkillBar.tsx
index c83c305..8b0d3f5 100644
--- a/src/components/SkillBar.tsx
+++ b/src/components/SkillBar.tsx
@@ -1,4 +1,4 @@
-import React from 'react';
+
...
## fix: minor adjustment to hero text: (c71c4e3) - 2026-01-26

```diff
diff --git a/src/pages/About.tsx b/src/pages/About.tsx
index 32158cd..b50a029 100644
--- a/src/pages/About.tsx
+++ b/src/pages/About.tsx
...
## docs: update readme (1b4c994) - 2026-01-27

```diff
diff --git a/README.md b/README.md
new file mode 100644
index 0000000..d043270
--- /dev/null
+++ b/README.md
@@ -0,0 +1,65 @@
+# The Alvian Zachry Faturrahman Portfolio Experience™
+
+> *Warning: Contains excessive amounts of "Regional Manager" energy and mathematically generated worms. Proceed with caution.*
+
...
+
+This isn't just a portfolio; it's a **React-Vite-TypeScript-Tailwind-FramerMotion** masterpiece that I built to make myself feel better about all the `create-react-app` projects I abandoned in 2019.
+
...
+*   **Why?** Because a static white background is for people who don't know how to abuse their CPU.
...
+*   **JSON-LD Schema**: I injected structured data so Google's AI knows *exactly* who I am. I am feeding the basilisk directly.
...
+Feel free to steal `WormBackground.tsx`. I know that's the only reason you're looking at the code.
...
## docs: update readme (0152650) - 2026-01-27

```diff
diff --git a/README.md b/README.md
index d043270..1b55a5e 100644
--- a/README.md
+++ b/README.md
@@ -8,16 +8,28 @@ This isn't just a portfolio; it's a **React-Vite-TypeScript-Tailwind-FramerMotio
...
@@ -33,6 +45,11 @@ I didn't just add meta tags; I performed a ritual summoning for the search engin
*   **JSON-LD Schema**: I injected structured data so Google's AI knows *exactly* who I am. I am feeding the basilisk directly.
*   **OpenGraph**: My links look so good on Slack that my coworkers might actually click them for once.

+### 👮 The Fun Police (Strict Linting)
+*   **Husky & Lint-Staged**: I cannot commit code if it's ugly.
...
I built this app with a stack that says "I have too much free time."
@@ -43,6 +60,7 @@ I built this app with a stack that says "I have too much free time."
*   **Framer Motion**: Used everywhere. If an element enters the DOM without a specialized dance routine, did it really render?
*   **Tailwind CSS**: 50 utility classes in one `className` string. Readability is subjective.
*   **React Helmet Async**: Managing document heads asynchronously because I live in the future.
+*   **Vitest**: For testing things that definitely didn't need testing.

## 🏃 How to Run My Masterpiece

@@ -57,6 +75,9 @@ npm run dev

# Generate the sitemap (and expose my Blogger secrets)
npm run generate-sitemap
+
+# Run the tests (to prove I didn't break the worms)
+npm test
```
...
## fix: resolve unreadable texts on dark modes (d14a3e9) - 2026-01-27

```diff
diff --git a/src/components/games/FlexPlayground.tsx b/src/components/games/FlexPlayground.tsx
index cdc9695..fea952f 100644
--- a/src/components/games/FlexPlayground.tsx
+++ b/src/components/games/FlexPlayground.tsx
...
diff --git a/src/pages/games/BugSquash.tsx b/src/pages/games/BugSquash.tsx
index d5cd1e4..9dcf478 100644
--- a/src/pages/games/BugSquash.tsx
+++ b/src/pages/games/BugSquash.tsx
@@ -84,17 +84,17 @@ export default function BugSquash() {
}
...
className={`h-full ${health < 30 ? 'bg-red-500' : 'bg-green-500'}`}
animate={{ width: `${health}%` }}
@@ -108,7 +108,7 @@ export default function BugSquash() {
<div className="pointer-events-auto flex gap-4">
<button
onClick={() => setIsPaused(!isPaused)}
-              className="px-4 py-2 bg-white dark:bg-slate-800 text-slate-900 dark:text-white rounded-lg shadow-lg font-bold border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors"
...
@@ -125,17 +125,17 @@ export default function BugSquash() {
...
diff --git a/src/pages/games/ElusiveDeploy.tsx b/src/pages/games/ElusiveDeploy.tsx
index 9d23d80..79a4882 100644
--- a/src/pages/games/ElusiveDeploy.tsx
+++ b/src/pages/games/ElusiveDeploy.tsx
...
Reset Shame
diff --git a/src/pages/games/LearnFlex.tsx b/src/pages/games/LearnFlex.tsx
index 95bf3fa..cf66ad3 100644
--- a/src/pages/games/LearnFlex.tsx
+++ b/src/pages/games/LearnFlex.tsx
@@ -3,19 +3,19 @@ import FlexPlayground from '../../components/games/FlexPlayground';
...
diff --git a/src/pages/games/LearnTypeScript.tsx b/src/pages/games/LearnTypeScript.tsx
index 6e47847..4a5701b 100644
--- a/src/pages/games/LearnTypeScript.tsx
+++ b/src/pages/games/LearnTypeScript.tsx
@@ -3,16 +3,16 @@ import TypeEditor from '../../components/games/TypeEditor';
...
Replace the <span className="font-mono text-red-500">any</span> with something that makes the linter happy (and your colleagues confused).
diff --git a/src/pages/games/QuickSync.tsx b/src/pages/games/QuickSync.tsx
index 7024af8..5fa1790 100644
--- a/src/pages/games/QuickSync.tsx
+++ b/src/pages/games/QuickSync.tsx
...
## docs: update README (9209219) - 2026-01-28

```diff
diff --git a/README.md b/README.md
index f962bc8..fbe1804 100644
--- a/README.md
+++ b/README.md
@@ -1,10 +1,10 @@
# The Alvian Zachry Faturrahman Portfolio Experience™
...
@@ -42,19 +42,40 @@ I made an entire page dedicated to **roasting you**.
### 🤖 SEO & AIO (Feeding the Robot Overlords)
I didn't just add meta tags; I performed a ritual summoning for the search engine bots.
*   **Dynamic Blogger API Integration**: I wrote a Node.js script that literally fetches data from the **Blogger API** to generate my XML sitemap. Yes, I use Blogger. STOP LAUGHING. It works.
-*   **JSON-LD Schema**: I injected structured data so Google's AI knows *exactly* who I am. I am feeding the basilisk directly.
...
@@ -62,13 +83,24 @@ Because every professional portfolio needs a way to waste the recruiter's time.
...
@@ -78,17 +110,36 @@ If you truly want to run this locally and see my worms wiggle on your own localh
# Install the entire internet
npm install
...
## fix: PWA preventing sitemap to be accessed (cca0d16) - 2026-01-28

```diff
diff --git a/vite.config.ts b/vite.config.ts
index 2c6439d..0113063 100644
--- a/vite.config.ts
+++ b/vite.config.ts
...
## fix: change brand to lower case (7435647) - 2026-01-28

```diff
diff --git a/src/components/Footer.tsx b/src/components/Footer.tsx
index 6ce83bd..aae6d28 100644
--- a/src/components/Footer.tsx
+++ b/src/components/Footer.tsx
...
## feat: idk man (b786eaf) - 2026-01-28
...
## fix: copywriting on npm packages (d3e460a) - 2026-01-28

```diff
diff --git a/src/data.ts b/src/data.ts
index 2d39fb2..ffed933 100644
--- a/src/data.ts
+++ b/src/data.ts
...
## fix: copywriting on npm packages (262797b) - 2026-01-28

```diff
diff --git a/src/components/Header.tsx b/src/components/Header.tsx
index 5edb1c5..8de313d 100644
--- a/src/components/Header.tsx
+++ b/src/components/Header.tsx
...
## fix: make worm background visible on experience and mentorship pages (a38508b) - 2026-01-28

```diff
diff --git a/src/data.ts b/src/data.ts
index ffed933..2011de0 100644
--- a/src/data.ts
+++ b/src/data.ts
@@ -390,7 +390,7 @@ export const categories: Category[] = [
export const npmPackages: NpmPackage[] = [
...
## fix robots (bb72efa) - 2026-01-28

```diff
diff --git a/public/robots.txt b/public/robots.txt
index f6cb4a1..9d01ed3 100644
--- a/public/robots.txt
+++ b/public/robots.txt
@@ -1,4 +1,4 @@
User-agent: *
...
## feat: restructure nav, new home, and about page with readme content (a7f056a) - 2026-01-28

```diff
diff --git a/README.md b/README.md
index abba6a0..cd91d86 100644
--- a/README.md
+++ b/README.md
...
## feat: complete about page content with readme sections (3f3b3f2) - 2026-01-28

```diff
diff --git a/src/pages/About.tsx b/src/pages/About.tsx
index d8b2d62..e06cdeb 100644
--- a/src/pages/About.tsx
+++ b/src/pages/About.tsx
@@ -1,10 +1,16 @@
import { motion } from 'framer-motion';
...
<div className="rounded-xl overflow-hidden border border-[var(--border-color)] shadow-xl rotate-1 hover:rotate-0 transition-transform duration-300">
@@ -168,6 +126,278 @@ const toggleTheme = () => {
</div>
</motion.section>
...
## fix(about): correct syntax in code snippet and complete page content (5470eae) - 2026-01-28

```diff
diff --git a/src/pages/About.tsx b/src/pages/About.tsx
index e06cdeb..ecdeed9 100644
--- a/src/pages/About.tsx
+++ b/src/pages/About.tsx
...
## fix(about): improve theme engine section layout and list alignment (298d519) - 2026-01-28

```diff
diff --git a/src/pages/About.tsx b/src/pages/About.tsx
index ecdeed9..cf2ebf4 100644
--- a/src/pages/About.tsx
+++ b/src/pages/About.tsx
...
## feat(about): add github repository link (f99b505) - 2026-01-28

```diff
diff --git a/src/pages/About.tsx b/src/pages/About.tsx
index cf2ebf4..793ccd8 100644
--- a/src/pages/About.tsx
+++ b/src/pages/About.tsx
...
## feat(about): add sarcastic test snippet (4832d4f) - 2026-01-28

```diff
diff --git a/src/pages/About.tsx b/src/pages/About.tsx
index 793ccd8..2fd2566 100644
--- a/src/pages/About.tsx
+++ b/src/pages/About.tsx
...
## feat(about): add internal tools, arcade games, and complex logic snippets (9557b87) - 2026-01-28

```diff
diff --git a/src/pages/About.tsx b/src/pages/About.tsx
index 2fd2566..768a700 100644
--- a/src/pages/About.tsx
+++ b/src/pages/About.tsx
...
## fix(about): correct lint snippet syntax and remove placeholder (9761e98) - 2026-01-28

```diff
diff --git a/src/pages/About.tsx b/src/pages/About.tsx
index 768a700..f4f4791 100644
--- a/src/pages/About.tsx
+++ b/src/pages/About.tsx
@@ -135,6 +135,51 @@ async function generateSitemap() {
fs.writeFileSync('public/sitemap.xml', sitemap);
}`;
...
## fix(about): re-insert missing Fun Police lint snippet section (e3b9012) - 2026-01-28

```diff
diff --git a/src/pages/About.tsx b/src/pages/About.tsx
index f4f4791..939e1c7 100644
--- a/src/pages/About.tsx
+++ b/src/pages/About.tsx
...
## feat(home): add promo popup and fix resume extension (38ef8f4) - 2026-01-28

```diff
diff --git a/src/components/PromoPopup.tsx b/src/components/PromoPopup.tsx
new file mode 100644
index 0000000..a4f7cb8
--- /dev/null
+++ b/src/components/PromoPopup.tsx
@@ -0,0 +1,77 @@
+import { useState, useEffect } from 'react';
+import { motion, AnimatePresence } from 'framer-motion';
...
## fix(home): rename resume file to force pdf extension (bbdf66b) - 2026-01-28

```diff
diff --git a/public/resume.pdf b/public/Alvian_Zachry_CV.pdf
similarity index 100%
rename from public/resume.pdf
rename to public/Alvian_Zachry_CV.pdf
diff --git a/src/pages/Home.tsx b/src/pages/Home.tsx
index 787df50..8a45e78 100644
--- a/src/pages/Home.tsx
+++ b/src/pages/Home.tsx
...
-                <a href="/resume.pdf" download="Alvian_Zachry_CV.pdf" className="text-[var(--text-secondary)] hover:text-brand-red font-medium flex items-center gap-2 px-6 py-3 transition-colors">
+                <a href="/Alvian_Zachry_CV.pdf" download className="text-[var(--text-secondary)] hover:text-brand-red font-medium flex items-center gap-2 px-6 py-3 transition-colors">
Download CV <Download className="w-4 h-4" />
</a>
</div>
...
## fix(pwa): exclude CV pdf from pwa navigation fallback (ac3c450) - 2026-01-28

```diff
diff --git a/vite.config.ts b/vite.config.ts
index 0113063..5672b61 100644
--- a/vite.config.ts
+++ b/vite.config.ts
...
## fix(links): update all resume links to new filename and add target blank (b23e7e0) - 2026-01-28

```diff
diff --git a/src/pages/Experience.tsx b/src/pages/Experience.tsx
index 83e2110..060fc92 100644
--- a/src/pages/Experience.tsx
+++ b/src/pages/Experience.tsx
@@ -301,8 +301,10 @@ export default function Experience() {
className="mt-12 text-center"
>
<a
-            href="/resume.pdf"
...
-                <a href="/Alvian_Zachry_CV.pdf" download className="text-[var(--text-secondary)] hover:text-brand-red font-medium flex items-center gap-2 px-6 py-3 transition-colors">
+                <a href="/Alvian_Zachry_CV.pdf" download="Alvian_Zachry_CV.pdf" target="_blank" rel="noopener noreferrer" className="text-[var(--text-secondary)] hover:text-brand-red font-medium flex items-center gap-2 px-6 py-3 transition-colors">
Download CV <Download className="w-4 h-4" />
</a>
</div>
...
## fix: add ScrollToTop and bust cache for resume download (33bffab) - 2026-01-28

```diff
diff --git a/src/App.tsx b/src/App.tsx
index 9969956..1b91fab 100644
--- a/src/App.tsx
+++ b/src/App.tsx
...
-                <a href="/Alvian_Zachry_CV.pdf" download="Alvian_Zachry_CV.pdf" target="_blank" rel="noopener noreferrer" className="text-[var(--text-secondary)] hover:text-brand-red font-medium flex items-center gap-2 px-6 py-3 transition-colors">
+                <a href="/Alvian_Zachry_CV.pdf?v=2" download="Alvian_Zachry_CV.pdf" target="_blank" rel="noopener noreferrer" className="text-[var(--text-secondary)] hover:text-brand-red font-medium flex items-center gap-2 px-6 py-3 transition-colors">
Download CV <Download className="w-4 h-4" />
</a>
</div>
...
## fix(links): remove download attribute and bump cache buster to v3 (7de7ca3) - 2026-01-28

```diff
diff --git a/src/pages/Experience.tsx b/src/pages/Experience.tsx
index d794212..2d875ae 100644
--- a/src/pages/Experience.tsx
+++ b/src/pages/Experience.tsx
@@ -301,8 +301,7 @@ export default function Experience() {
className="mt-12 text-center"
>
<a
-            href="/Alvian_Zachry_CV.pdf?v=2"
...
-                <a href="/Alvian_Zachry_CV.pdf?v=2" download="Alvian_Zachry_CV.pdf" target="_blank" rel="noopener noreferrer" className="text-[var(--text-secondary)] hover:text-brand-red font-medium flex items-center gap-2 px-6 py-3 transition-colors">
+                <a href="/Alvian_Zachry_CV.pdf?v=3" target="_blank" rel="noopener noreferrer" className="text-[var(--text-secondary)] hover:text-brand-red font-medium flex items-center gap-2 px-6 py-3 transition-colors">
Download CV <Download className="w-4 h-4" />
</a>
</div>
...
## fix(links): remove cache buster version param from resume links (2eb1d30) - 2026-01-28

```diff
diff --git a/src/pages/Experience.tsx b/src/pages/Experience.tsx
index 2d875ae..be98a4f 100644
--- a/src/pages/Experience.tsx
+++ b/src/pages/Experience.tsx
@@ -301,7 +301,7 @@ export default function Experience() {
className="mt-12 text-center"
...
## fix(footer): update sitemap links (ae90798) - 2026-01-28

```diff
diff --git a/src/components/Footer.tsx b/src/components/Footer.tsx
index 1cff211..58832eb 100644
--- a/src/components/Footer.tsx
+++ b/src/components/Footer.tsx
...
## fix: resolve latex.js build error by handling .keep files (1df78a2) - 2026-02-02

```diff
diff --git a/vite.config.ts b/vite.config.ts
index 5672b61..8909d0c 100644
--- a/vite.config.ts
+++ b/vite.config.ts
...
## fix: remove invalid aggregateRating from Person schema (1164a2e) - 2026-02-02

```diff
diff --git a/src/pages/Home.tsx b/src/pages/Home.tsx
index 3e18763..38adba9 100644
--- a/src/pages/Home.tsx
+++ b/src/pages/Home.tsx
